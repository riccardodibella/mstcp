...
# Configuration
TIMEOUT_DURATION=120  # Timeout in seconds for each operation
...
FILENAME="aggregate_test_$(date +%Y%m%d_%H%M%S).csv"
echo $FILENAME

echo "MS_ENABLED;num_clients;requests;payload_size;time_ms;dl_bytes;ul_bytes" > $FILENAME
