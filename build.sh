...
if [[ "$1" == "--local" ]]; then
    gcc 15.c -O3 -g -DMAIN_MODE=SERVER -DLOCAL_SERVER -o server.out
else
    scp 15.c dibella@172.104.237.69:/home/dibella
    ssh dibella@172.104.237.69 'gcc 15.c -O3 -g -DMAIN_MODE=SERVER -o server.out'
fi
